...
import com.dogukancifci.tokenmail.ForRegisterTokenEmailConfirmationEntity;
import com.dogukancifci.tokenmail.IForRegisterTokenEmailConfirmationEntity;
import com.dogukancifci.tokenmail.IForRegisterTokenEmailConfirmationServices;
...
public class RegisterServicesImpl implements IRegisterServices<RegisterDto, RegisterEntity> {
    ...
    public RegisterDto registerServiceFindById(Long id) {
        ...
        if (booleanRegisterEntityFindById) {
            ...
            throw new DogukanCifciException("Roles Dto id boş değer geldi");
        }
