...
import com.dogukancifci.business.dto.BlogCategoryDto;
import com.dogukancifci.business.services.IBlogCategoryServices;
import com.dogukancifci.data.entity.BlogCategoryEntity;
import com.dogukancifci.data.repository.IBlogCategoryRepository;
    ...
    public BlogCategoryDto categoryServiceFindById(Long id) {
        ...
        */
        ...
        if (id != null) {
            ...
            throw new DogukanCifciException("İd null olarak geldi");
        }
